...
const getCurrentUser  = asyncHandler (async (req,res) => {
    ...
    return res
    .status(200)
    .json(new ApiResponse(200 , user , "Current user fetced successfully"))
})
 ...
 *  / / / / / / / / / / / / / /
 */
// Remember when we have to handle file to update we have two middleware -> multer , user loggedin hai ki nhi
...
const getUserChannelProfile = asyncHandler( async (req, res) => {
    ...
    //jb hum kuch url se data chahiye to hum params ke through nikalte hai
...
const getWatchHistory = asyncHandler (async (req , res) => {
    ...
    //User ki watch History nikalni hai
